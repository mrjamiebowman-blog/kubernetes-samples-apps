...
namespace MrJB.Kubernetes.Orders.Api;
...
internal sealed class OTel
{
    ...
    /// </summary>
    internal static readonly string ActivitySourceName = AssemblyName?.Name ?? "MrJB.Kubernetes.Orders.Api";
    ...
    {
        internal const string BaseName = "mrjb.k8s.orders.api";
    }
