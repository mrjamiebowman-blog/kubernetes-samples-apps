...
namespace MrJB.Kubernetes.Customers.Consumer;
...
internal sealed class OTel
{
    ...
    /// </summary>
    internal static readonly string ActivitySourceName = AssemblyName?.Name ?? "MrJB.Kubernetes.Customers.Consumer";
    ...
    {
        internal const string BaseName = "mrjb.k8s.customers.consumer";
    }
