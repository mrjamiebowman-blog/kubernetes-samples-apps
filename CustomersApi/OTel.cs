...
internal sealed class OTel
{
    ...
    /// </summary>
    internal static readonly string ActivitySourceName = AssemblyName?.Name ?? "MrJB.Kubernetes.Customers.Api";
    ...
    {
        internal const string BaseName = "mrjb.k8s.customers.api";
    }
